            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    >
                        ...
                        <div>
                            <InputLabel htmlFor="task_project_id" value="Select Project"/>
                            <SelectInput
                                id="task_project_id"
                                name="project_id"
                        ...
                        <div className='mt-4'>
                            <InputLabel htmlFor="task_image_path" value="Task Image"></InputLabel>
                            <TextInput 
                                id="task_image_path"
                                type="file"
                                name="image"
                        ...
                        <div className='mt-4'>
                            <InputLabel htmlFor="task_description" value="Task Description"></InputLabel>
                            <TextAreaInput 
                                id="task_description"
                                name="description"
                        ...
                        <div className='mt-4'>
                            <InputLabel htmlFor="task_due_date" value="Task Due Date"></InputLabel>
                            <TextInput 
                                id="task_due_date"
                                type="date"
                                name="due_date"
