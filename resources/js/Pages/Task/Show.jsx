            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div>
                            <img src={task.image_path} alt="image" className="w-full h-64 object-cover"/>
                        </div>
                            ...
                            <div className="grid gap-1 grid-cols-2 mt-2">
                                <div>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-1">
                                            <span 
                                            className={"px-2 py-1 rounded text-white " + TASK_PRIORITY_CLASS_MAP[task.priority]}> {TASK_PRIORITY_TEXT_MAP[task.priority]}
                                            </span>
                                        </p>
                                    </div>
                                    <div className="mt-4">
                                ...
                                <div>
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-1">
                                            <Link href={route('project.show', task.project.id)} className="text-blue hover:underline">
                                            {task.project.name}
                                            </Link>
                                        </p>
                                    </div>
